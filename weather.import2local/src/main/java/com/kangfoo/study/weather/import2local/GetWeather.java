package com.kangfoo.study.weather.import2local;
...
public interface GetWeather {
    ...
    public static final String URL = "http://www.weather.com.cn/data/cityinfo/%s.html";
...
//    "台北","高雄"
    ...
    public static final List<String> citys = new ArrayList<String>(Arrays.asList(cityStr));
