package com.kangfoo.study.weather.import2local.impl;

import com.kangfoo.study.weather.import2local.GetWeather;
...
public class GetWeatherImpl implements GetWeather {
    ...
    public void importData() {
        ...
        for (String city : GetWeather.citys){
            ...
            print2log( getWeather(url) );   break;
        }
    ...
    public void print2log(String log){
        logger.info(log);
    }
